		...
		var g = {
					 ...
					 function(i,row) 
					 	{
							...
							var url_target_request = replaceAll(document.location.href, 'myaccount/invoice_list', 'x_page.php');
							tr.setAttribute('onClick', "makeRequestPop('"+url_target_request+"', 'process_container','page=x_detail_inv&page_required=1&act=show&id="+row.id+"');$.fn.colorbox({width:'900px', height:'90%', inline:true, href:'#process_container'});");
							//add cell
			...
			populate: function () { //get latest data
				...
				var param = [
					...
					,{ name : 'where_status', value : p.where_status }
